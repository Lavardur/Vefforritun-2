...
export default function Page() {
  return (
    <>
      ...
      <ul>
        <li>
          Uppsetning og notkun á <a href="https://nextjs.org/">Next.js</a>.
        </li>
      ...
      <h2>Virkni</h2>
      <p>
        Verkefnið er viljandi opið og ekki mikið skilgreint. Það er í lagi að einhver skörun sé við
      ...
      <ul>
        <li>
          <a href="https://www.datocms.com/">DatoCMS</a>. Við munum vinna gunnvinnu með DatoCMS í
          fyrirlestri.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Stakar síður með efni sem hægt er að breyta í kerfinu, t.d. stök frétt eða grein. Að
          minnsta kosti titill og texti.
        </li>
      </ul>
      <p>
        Æskilegt er að finna kennsluefni (tutorial) fyrir valið kerfi og fylgja því að einhverju
        leiti. T.d.{' '}
        <a href="https://github.com/vercel/next.js/tree/canary/examples">
          er mikið af dæmum á Next.js GitHub
        </a>
        . Athugið samt að einhver dæmin nota pages router ekki app router.
      </p>
      ...
      <ul>
        ...
        <li>
          Slóð á GitHub repo fyrir verkefni. Dæmatímakennurum skal hafa verið boðið í repo.
      ...
      <h2>Einkunn</h2>
      <p>
        Leyfilegt er að ræða, og vinna saman að verkefni en{' '}
        <strong>skrifið ykkar eigin lausn</strong>. Ef tvær eða fleiri lausnir eru mjög líkar þarf
        að færa rök fyrir því, annars munu allir hlutaðeigandi hugsanlega fá 0 fyrir verkefnið.
      </p>
      <p>
        Ef stórt mállíkan (LLM, „gervigreind“, t.d. ChatGTP) er notað til að skrifa part af lausn
        skal taka það fram.{' '}
        <a href="https://gervigreind.hi.is/">Sjá nánar á upplýsingasíða um gervigreind hjá HÍ</a>.
      </p>
      <p>
        Sett verða fyrir (
        <a href="https://github.com/vefforritun/vef2-2025/blob/main/namsefni/01.kynning/1.kynning.md">
          sjá nánar í kynningu á áfanga
        </a>
        ):
      </p>
      <ul>
